...
| [Finding backlog and paths](finding-backlog-and-paths.md) | Where `BACKLOG.md` lives in a **full** workspace; Quick Open, Explorer, Finder, terminal |
| [Enable transcript backlog scan](enable-transcript-backlog-scan.md) | **Full workspace:** local script to draft todos from `agent-transcripts` — see [`../INDEX-full-workspace-only.md`](../INDEX-full-workspace-only.md) |

Slash command summaries that work without `.cursor/` on disk: [`../reference/slash-commands.md`](../reference/slash-commands.md).

Add new files here; update [`../INDEX.md`](../INDEX.md).
